/**
* @file doctorCaseDetailFU.controller.js
...
(function () {
    ...
    angular
        ...
        .controller('DoctorCaseDetailFUCtrl', DoctorCaseDetailFUCtrl);

    DoctorCaseDetailFUCtrl.$inject = ['$scope', '$state', 'followupService', 'FU_STATUS_DICT', 'FU_TYPE_DICT'];

    /**
     * @namespace DoctorCaseDetailFUCtrl
     * @description Controller of the case follow up view
     * @permissions isSurgeonCase, isDoctorCase, isPatientCase
     */
    function DoctorCaseDetailFUCtrl($scope, $state, followupService, FU_STATUS_DICT, FU_TYPE_DICT) {
